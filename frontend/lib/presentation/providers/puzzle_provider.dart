...
final puzzleRepositoryProvider = Provider<PuzzleRepository>((ref) {
  return PuzzleRepository(PuzzleRemoteDataSource(ref.watch(apiClientProvider)));
});
...
final puzzleControllerProvider =
    StateNotifierProvider<PuzzleController, AsyncValue<List<PuzzleModel>>>((ref) {
  return PuzzleController(ref.watch(puzzleRepositoryProvider));
});

final puzzleAttemptProvider =
    FutureProvider.family<PuzzleAttemptResult, PuzzleAttemptInput>(
  (ref, input) async {
    return ref.watch(puzzleRepositoryProvider).attempt(
