...
CAMERA_WIDTH = int(_get_env("ROBOCHESS_CAPTURE_WIDTH", "820"))
CAMERA_HEIGHT = int(_get_env("ROBOCHESS_CAPTURE_HEIGHT", "620"))
...
ROBOFLOW_MODEL_URL = _get_env("ROBOCHESS_ROBOFLOW_MODEL_URL", "")
ROBOFLOW_API_KEY = _get_env("ROBOCHESS_ROBOFLOW_API_KEY", "")
