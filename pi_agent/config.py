...
BLE_ENABLED = _get_env_bool("ROBOCHESS_BLE_ENABLED", "1")
...
BLE_NAME = _get_env("ROBOCHESS_BLE_NAME", "RoboChess Pi")
...
GANTRY_HOME_MODE = _get_env("ROBOCHESS_GANTRY_HOME_MODE", "never")
GANTRY_REHOME_INTERVAL = int(_get_env("ROBOCHESS_GANTRY_REHOME_INTERVAL", "50"))
...
VISION_REQUIRE_INTERNET = _get_env_bool("ROBOCHESS_VISION_REQUIRE_INTERNET", "0")
ROBOFLOW_MODEL_URL = _get_env(
    "ROBOCHESS_ROBOFLOW_MODEL_URL",
    _get_env("ROBOFLOW_MODEL_URL", "chess-yimaf-jwsta/5"),
)
ROBOFLOW_API_KEY = _get_env(
    "ROBOCHESS_ROBOFLOW_API_KEY",
    _get_env("ROBOFLOW_API_KEY", "1OyUTcW3mg1dcln38uRg"),
)
ROBOFLOW_ENABLED = _get_env_bool("ROBOCHESS_ROBOFLOW_ENABLED", "1")
if not ROBOFLOW_ENABLED and ROBOFLOW_MODEL_URL and ROBOFLOW_API_KEY:
    ROBOFLOW_ENABLED = True
if VISION_MODE == "cloud":
    ROBOFLOW_ENABLED = True
ROBOFLOW_TIMEOUT_SECONDS = float(_get_env("ROBOCHESS_ROBOFLOW_TIMEOUT_SECONDS", "5"))
