...
GAME_MESSAGE_TYPES = {"session.start", "session.reset", "session.resume", "session.undo", "state.request", "move.propose", "gantry.home", "gantry.status", "camera.calibrate", "camera.status", "network.scan"}
